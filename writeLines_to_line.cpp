...
int main()
{
	...
	int leter = countLetters(myFile);
	rewind(myFile);
	int word = countWord(myFile);
	printf("Number of letters in the file is: %d ", leter);
	printf("Number of word in the file is: %d ", word);
	return 0;
}
